...
Config.DeliveryLocations = {
    ['main'] = { label = 'GO Poçt', coords = vector4(69.0862, 127.6753, 79.2123, 156.7736) },
...
Config.Products = {
    ...
    ['police'] = {
        { name = 'weapon_pistol',       price = 0, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_PI_FLSH', label = 'Fənər' } } } },
        { name = 'weapon_stungun',      price = 0, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Fənər' } } } },
        { name = 'weapon_pumpshotgun',  price = 0, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Fənər' } } } },
        { name = 'weapon_smg',          price = 0, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_SCOPE_MACRO_02', label = '1x Optik' }, { component = 'COMPONENT_AT_AR_FLSH', label = 'Fənər' } } } },
        { name = 'weapon_carbinerifle', price = 0, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Fənər' }, { component = 'COMPONENT_AT_SCOPE_MEDIUM', label = '3x Optik' } } } },
...
Config.Locations = {
    ...
    ['ammunation'] = {
        ['label'] = 'Silah Mağazası (Ammunation)',
        ['type'] = 'weapon',

local Translations = {
    error = {
        ...
        ["house_rented"] = "Bu ev icarədədir!",
        ["already_rented"] = "Bu evi artıq icarəyə götürmüsünüz.",
        ["not_enough_money_rent"] = "Kifayət qədər pul yoxdur — icarə: ₣%{price}",
        ["rent_expired"] = "⌛ Ev icarəsinin müddəti bitdi — giriş bağlandı.",
    ...
    success = {
        ["house_rented"] = "🏠 %{address} ünvanlı ev icarəyə götürüldü (₣%{price} / həftə)!" ,
        ["unlocked"] = "Ev açıldı!",
    ...
    menu = {
        ...
        ["open_door"] = "Qapını Aç",
        ["view_house"] = "Evə Bax",
        ["rent_house"] = "🏠 İcarə et (₣%{price} / həftə)",

...
-- Əmlak agentliyi
Config.Agency = {
    name = 'Daşınmaz Əmlak Agentliyi (20 Yanvar)',
...
-- Satışda olan evlər
Config.Houses = {
    { id = 'ev_1', name = 'Mənzil — Legion Meydanı (28 May)', desc = 'Şəhərin mərkəzində rahat mənzil.', price = 150000, coords = vector3(230.0, -860.0, 30.5), heading = 160.0 },
    { id = 'ev_2', name = 'Mənzil — Vinewood (Nəriman Nərimanov)', desc = 'Dəbdəbəli məhəllədə geniş mənzil.', price = 220000, coords = vector3(310.0, 190.0, 104.0), heading = 150.0 },
    ...
    { id = 'ev_4', name = 'Sahil Evi — Del Perro (20 Yanvar)', desc = 'Çimərliyə baxan gözəl sahil evi.', price = 350000, coords = vector3(-1450.0, -1000.0, 8.0), heading = 250.0 },
    { id = 'ev_5', name = 'Villa — Rockford Hills (Gənclik)', desc = 'Şəhərin ən dəbdəbəli villası.', price = 1200000, coords = vector3(-740.0, 260.0, 99.0), heading = 20.0 },
    ...
    { id = 'ev_10', name = 'Göl Evi — Alamo (Dərnəgül)', desc = 'Gölə baxan mənzərəli ev.', price = 120000, coords = vector3(1320.0, 4250.0, 33.0), heading = 180.0 },
    { id = 'ev_11', name = 'Dağ Evi (Qəbələ)', desc = 'Təpədə, mənzərəli dağ evi.', price = 180000, coords = vector3(450.0, 5400.0, 150.0), heading = 270.0 },
    { id = 'ev_12', name = 'Mənzil — Strawberry (20 Yanvar)', desc = 'Məhəllə həyatının ortasında mənzil.', price = 75000, coords = vector3(-1150.0, -900.0, 14.0), heading = 90.0 },
}

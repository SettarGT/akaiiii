...
Config.Locations = {
    ...
    {
        id = 'belediye_bina', name = 'Bələdiyyə binası',
    ...
    {
        id = 'vətendaş_qeydiyyəti', name = 'Vətəndaş qeydiyyatı şöbəsi',
    ...
    {
        id = 'mehkeme', name = 'Məhkəmə binası',
    ...
    {
        id = 'polis_merkez', name = 'Polis İdarəsi (Mission Row)',
    ...
    {
        id = 'polis_sandy', name = 'Sandy Shores Polis Bölməsi',
    ...
    {
        id = 'yanğın_stansiya', name = 'Yanğınsöndürən stansiyası',
    ...
    -- ==================== SƏHİYYƏ ====================
    {
        id = 'xeshtexana', name = 'Pillbox Xəstəxanası',
    ...
    {
        id = 'klinika_sandy', name = 'Sandy Shores Klinikası',
    ...
    {
        id = 'heyvan_xestexanasi', name = 'Heyvan Klinikası',
    ...
    {
        id = 'bank_fleeca_1', name = 'Fleeca Bank — Alta',
    ...
    -- ==================== NƏQLİYYAT ====================
    {
        id = 'avtovağzal', name = 'Şəhər Avtovağzalı',
    ...
    {
        id = 'dəmiryol_stansiya', name = 'Union Dəmiryol Stansiyası',
    ...
    {
        id = 'hava_limani', name = 'Los Santos Beynəlxalq Hava Limanı',
    ...
    {
        id = 'heliport', name = 'Los Santos Heliportu',
    ...
    {
        id = 'liman_elysian', name = 'Elysian Limanı',
    ...
    {
        id = 'marina', name = 'Vespucci Marina',
    ...
    {
        id = 'taksi_dayanacaq', name = 'Taksi Dayanacağı',
    ...
    {
        id = 'market_legion', name = '24/7 Market — Legion',
    ...
    {
        id = 'elektronika_mağaza', name = 'Elektronika Mağazası',
    ...
    {
        id = 'mebel_mağaza', name = 'Mebel Mağazası',
    ...
    {
        id = 'zerger_dukani', name = 'Zərgər Dükanı (Vangelico)',
    ...
    {
        id = 'kitab_mağaza', name = 'Kitab Mağazası',
    ...
    {
        id = 'çiçək_dukani', name = 'Çiçək Dükanı',
    ...
    {
        id = 'heyvan_mağaza', name = 'Heyvan Mağazası',
    ...
    {
        id = 'açıq_bazar', name = 'Açıq Kənd Bazarı',
    ...
    -- ==================== YEMƏK VƏ İÇKİ ====================
    {
        id = 'restoran_1', name = 'Restoran — Legion Meydanı',
    ...
    {
        id = 'fastfood', name = 'Fast Food — Burger Shot',
    ...
    {
        id = 'gecə_klubu', name = 'Vanilla Unicorn Gecə Klubu',
    ...
    {
        id = 'bar_tequila', name = 'Tequi-la-la Bar',
    ...
    {
        id = 'bar_bahama', name = 'Bahama Mamas Klubu',
    ...
    {
        id = 'golf_klub', name = 'Los Santos Golf Klubu',
    ...
    {
        id = 'kazino', name = 'Diamond Kazinosu',
    ...
    {
        id = 'legion_meydan', name = 'Legion Meydanı',
    ...
    {
        id = 'çimərlik_del_perro', name = 'Del Perro Çimərliyi',
    ...
    {
        id = 'çimərlik_vespucci', name = 'Vespucci Çimərliyi',
    ...
    {
        id = 'vinwood_təpə', name = 'Vinewood Təpəsi — Mənzərə Nöqtəsi',
    ...
    {
        id = 'ferma', name = 'Grapeseed Ferması',
    ...
    {
        id = 'zibilxana', name = 'Zibil İdarəsi',
    ...
    {
        id = 'yük_şirkəti', name = 'Yük Daşıma Şirkəti',
    ...
    {
        id = 'avtobus_depo', name = 'Avtobus Deposu',
    ...
    {
        id = 'çörək_zavodu', name = 'Çörək Zavodu',
    ...
    {
        id = 'ət_kombinatı', name = 'Ət Kombinatı',
    ...
    {
        id = 'tikiş_emalatxana', name = 'Tikiş Emalatxanası',
    ...
    {
        id = 'dəmirçi', name = 'Dəmirçi Emalatxanası',
    ...
    {
        id = 'elektrik', name = 'Elektrik Stansiyası',
    ...
    {
        id = 'peşə_məktəbi', name = 'Peşə Məktəbi',
    ...
    -- ==================== XİDMƏT SECTORU ====================
    {
        id = 'mexanik_1', name = 'Mexanik Emalatxanası — La Mesa',
    ...
    {
        id = 'mexanik_2', name = 'Mexanik Emalatxanası — La Puerta',
    ...
    {
        id = 'avtoyuma_2', name = 'Avtoyuma — Vespucci',
        desc = 'Avtomobilinizi təmizləyin.',
        coords = vector3(-698.6, -933.3, 19.0), color = { 120, 200, 255 }, marker = 1, size = 0.9,
        blip = { sprite = 100, color = 38, scale = 0.7 }, category = 'Xidmət'
    },
    {
        id = 'avtosalon', name = 'Premium Deluxe Avtosalon',
    ...
    {
        id = 'motosalon', name = 'Motosiklet Salonu',
    ...
    {
        id = 'bərbərxana_1', name = 'Bərbərxana — Legion',
    ...
    {
        id = 'saat_ustası', name = 'Saat Emalatxanası',
    ...
    {
        id = 'şüşəbənd', name = 'Şüşəbənd Emalatxanası',
    ...
    -- ==================== YANACAQ ====================
    {
        id = 'yanacaq_1', name = 'Yanacaqdoldurma Məntəqəsi — Legion',
    ...
    -- ==================== DAŞINMAZ ƏMLAK ====================
    {
        id = 'əmlak_agentliyi', name = 'Daşınmaz Əmlak Agentliyi',
    ...
    {
        id = 'villa_bölgəsi', name = 'Villa Bölgəsi — Rockford Hills',
    ...
    {
        id = 'yaşayış_zona', name = 'Yaşayış Zonası — Grove Street',
    ...
    {
        id = 'alaamo_gölü', name = 'Alamo Gölü',
    ...
    {
        id = 'palıd_meşə', name = 'Palmer-Taylor Meşəsi',
    ...
    -- ==================== SƏNAYE ====================
    {
        id = 'sənaye_zona', name = 'La Mesa Sənaye Zonası',
    ...
    {
        id = 'tikinti', name = 'Tikinti Sahəsi',

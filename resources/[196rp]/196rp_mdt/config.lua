...
Config.Fines = {
    { label = 'Sürət həddi (30+ km/s)',     amount = 500 },
    { label = 'Sürət həddi (60+ km/s)',     amount = 1000 },
    { label = 'Sürət həddi (120+ km/s)',    amount = 2500 },
    { label = 'Qırmızı işıq',               amount = 1000 },
    { label = 'Yanlış park',                amount = 250 },
    { label = 'Aqressiv sürmə',             amount = 750 },
    { label = 'Təhlükəli sürmə',            amount = 1500 },

...
Config.Garages = {
    ...
    { id = 'garage_sandy', name = 'Sandy Shores Qarajı (Qara Qarayev)', type = 'car', coords = vector3(549.2, 2669.2, 42.2) },
    { id = 'garage_paleto', name = 'Paleto Bay Qarajı (Qara Qarayev)', type = 'car', coords = vector3(-300.0, 6250.0, 31.5) },

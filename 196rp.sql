...
CREATE TABLE IF NOT EXISTS `196_tax_logs` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `citizenid` VARCHAR(11) DEFAULT NULL,
  `reason` VARCHAR(50) DEFAULT NULL,
  `amount` INT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `196_crypto` (
  `citizenid` VARCHAR(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `196_crypto_history` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `196_vip` (
  `citizenid` VARCHAR(11) NOT NULL,
...
-- ═══════ 196 RP | Heyvanlar ═══════
CREATE TABLE IF NOT EXISTS 196_pets (
...
-- ═══════ 196 RP | Parametrlər ═══════
CREATE TABLE IF NOT EXISTS 196_settings (
...
-- ═══════ 196 RP | Kazino fişləri ═══════
CREATE TABLE IF NOT EXISTS 196_chips (
  citizenid VARCHAR(50) NOT NULL,
  chips INT NOT NULL DEFAULT 0,
  daily_loss INT NOT NULL DEFAULT 0,
  last_loss_day DATE DEFAULT NULL,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (citizenid)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
